...
local callbacks = {
    update = function(dt)
        print(1, songSource:getFreeBufferCount(), samplesRead)
        while songSource:getFreeBufferCount() > 0 do
            print("reading samples", songSource:getFreeBufferCount(), samplesRead)
        ...
        print(2, songSource:getFreeBufferCount(), samplesRead)
